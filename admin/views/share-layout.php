      ...
      <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="dsdetai.php"><i class="fa fa-list fa-fw"></i> Quản lý đề tài</a>
            </li>
            <li>
              <a href="dsdoan.php"><i class="fa fa-files-o fa-fw"></i> Quản lý đồ án</a>
            </li>
            <li>
              <a href="dskhoa.php"><i class="fa fa-university fa-fw"></i> Quản lý khoa</a>
            </li>
            <li>
              <a href="dsgiangvien.php"><i class="fa fa-user-circle-o fa-fw"></i> Quản lý giảng viên</a>
            </li>
            <li>
              <a href="dssinhvien.php"><i class="fa fa-users fa-fw"></i> Quản lý sinh viên</a>
            </li>
            <li>
              <a href="dsthda.php"><i class="fa fa-address-book-o fa-fw"></i> Quản lý thực hiện đồ án</a>
            </li>
          </ul>
        </div>
        <!-- /.sidebar-collapse -->
